const collections = [
  {
    ...
    description: "17171717",
    view: "https://17-upcoming.netlify.app",
    github: "",
    images: [],
  },
  {
  ...
  },
  {
    ...
    logo: "./images/logo/heynotes.webp",
    description: "This web app has a very different background and has basic questions like why am I making this, why does it have to be like this, how to make it, all of that you can feel after you use it and explore it, so start using it.",
    view: "https://hey-notes.netlify.app",
    github: "https://github.com/hewrya/heynotes-resource",
    images: [
      { id: 0, url: "./images/ui/heyca.webp", },
      { id: 1, url: "./images/ui/heyca-0.webp", },
      { id: 2, url: "./images/ui/heyca-1.webp", },
      { id: 3, url: "./images/ui/heyca-2.webp", },
      { id: 4, url: "./images/ui/heyca-3.webp", },
      { id: 5, url: "./images/ui/heyca-4.webp", },
      { id: 6, url: "./images/ui/heyca-5.webp", },
      { id: 7, url: "./images/ui/heyca-6.webp", },
    ],
  },
  {
    id: 5,
    ...
    github: "https://github.com/hewrya/personal-notes-app-v2",
    images: [
  ...
  },
  {
    ...
    github: "https://github.com/hewrya/her-app-resource",
    images: [
  ...
  },
  {
    ...
    github: "https://github.com/hewrya/her-app-v2-resource",
    images: [
  ...
  },
  {
    ...
    github: "https://github.com/hewrya/epl-unofficial-resource",
    images: [
  ...
  },
  {
    ...
    github: "https://github.com/hewrya/personal-notes-app-resource",
    images: [
  ...
  },
  {
    ...
    github: "https://github.com/hewrya/mybooks-apps",
    images: [
  ...
  },
  {
    ...
    logo: "./images/logo/dsoccer.webp",
    description: "This is the first website I created using semantic HTML and also Flexbox to make it easier to place content. It's unexpected that I have reached this point. If you look at my flashback, when I was at that point I can't imagine what it felt like to be at the point I am now.",
    view: "https://dsoccer.netlify.app",
    github: "https://github.com/hewrya/dsoccer",
    images: [
...
// Ini adalah web pertama yang saya buat menggunakan semantic html dan juga flexbox agar dapat mempermudah dalam peletakan konten. Tidak disangka saya telah mencapai titik ini. Jika melihat kilas balik saya, saya saat berada dititik itu tidak dapat membayangkan bagaimana rasanya berada dititik saya saat ini.
